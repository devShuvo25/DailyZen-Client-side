...
const HabitsFeatures = ({children, direction = "left"}) => {
    ...
    return (
        <div className='p-5'>
            <h1 className='text-4xl font-semibold  text-center'>Latest Features</h1>
            <motion.div
             ...
             transition={{ duration: 0.8 }}
                ...
                <h1 className='text-4xl font-semibold text-center mb-10'>Why Build Habits?</h1>
             ...
             transition={{ duration: 0.8 }}
                className='flex justify-between items-start gap-5'>
                    ...
                    >
                        ...
                        <h2 className='text-2xl font-bold'>Why Build habit?</h2>
